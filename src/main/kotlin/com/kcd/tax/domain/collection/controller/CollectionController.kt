package com.kcd.tax.domain.collection.controller
...
class CollectionController(
    ...
    fun setCollectionRequest(
        ...
        collectionService.setCollectionRequest(dto)
    ...
    fun findCollectionStatus(
        ...
        val result = collectionService.findCollectionStatus(year, halfType, registrationNumber)
